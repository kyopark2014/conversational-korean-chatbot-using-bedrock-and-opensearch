...
```java
git clone https://github.com/kyopark2014/conversational-korean-chatbot-using-bedrock-and-opensearch
```

5) cdk 폴더로 이동하여 필요한 라이브러리를 설치합니다.

```java
cd conversational-korean-chatbot-using-bedrock-and-opensearch/cdk-bedrock-chatbot-with-os/ && npm install
```
...
cd ../cdk-bedrock-chatbot-with-os/
```
