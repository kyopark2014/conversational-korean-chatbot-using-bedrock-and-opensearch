...
const model_id = "amazon.titan-tg1-large"; // amazon.titan-tg1-large, anthropic.claude-v2
const projectName = `chatbot-bedrock-opensearch`;
...
export class CdkBedrockChatbotWithOsStack extends cdk.Stack {
